 ...
 * @author mbien
 */
public class LindenmayerSystemJava extends JFrame {
    ...
    public static void main(String args[]) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                LindenmayerSystemJava frame = new LindenmayerSystemJava();
